...
protocol OnlineGameViewDelegate: class{
    func sendIndex(_ index:IndexPath, isTopBoard:Bool)
}

class OnlineGameView: UIView, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    var data: [String] = []
    weak var onlinegameViewDelegate:OnlineGameViewDelegate? = nil
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
    {
        ...
        onlinegameViewDelegate?.sendIndex(indexPath, isTopBoard: isTopBoard)
    }
